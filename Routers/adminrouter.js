...
//View all drivers waiting for verification
router.get('/driververify', (req, res) => {
...
//View all voters waiting for verification
router.get('/voterverify', (req, res) => {
	User.find({verified: "false"})
	.then(data => res.status(200).json(data))
	.catch(err => {
		console.log(err);
...
//update a driver profile/account verified property
router.put('/driververify/:id', (req,res) => {
...
//update an voter profile/account verified property
router.put('/voterverify/:id', (req,res) => {
	User.findByIdAndUpdate(req.params.id, {$set: {verified: "true"}})
	.then(result => res.status(200).send('Account verified!'))
	.catch(err => {
		console.log(err);
